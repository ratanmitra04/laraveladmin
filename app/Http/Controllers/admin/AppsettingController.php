...
# Author          : KB                            
# Created Date    :                               
# Controller Name : AppsettingController               
# Purpose         : App Setting Management             
/***********************************************/
...
{
    use GeneralMethods;
    public $controllerName  = 'Appsetting';
    public $management;
    public $modelName       = 'Appsetting';
    public $breadcrumb;
    public $routePrefix     = 'appsettings';
    public $viewFolderPath  = 'admin/appsettings';
    ...
    */
    ...
    public function edit()
    {
        try{
            $id = 1;
            $data['id'] = $id;
            $data['record'] = Appsetting::find($id);
