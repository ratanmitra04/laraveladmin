                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    {{ Form::text('name', $record->name, array('required','class' => 'form-control','id' => 'name','placeholder' => 'Country Name')) }}
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    {{ Form::text('ccode', $record->ccode, array('class' => 'form-control','id' => 'ccode','placeholder' => 'Country Code')) }}
                                </div>
                            </div>
                        </div>
