            ...
            <div class="col-xs-12">
                <div class="box box-primary">
                    ...
                    <div class="col-sm-8">
                     ...
                     <label class="col-lg-3 control-label">Filter By Status:</label>
                     <div class="col-lg-8">
                        <div class="dropdown">
                    ...
                    <div class="box-body table-responsive no-padding">
                        <table class="table table-hover">
                            ...
                            <tr>
                                ...
                                <td>Basic Package</td>
                                <td>$50</td>
                                <td>12/08/2020 to 12/09/2020</td>
                                <td>
                                   <!-- <a class="link" href="{{ URL::Route($routePrefix.'.view',1) }}" title="Edit"><i class="fa fa-edit"></i></a>-->
                                <!--<a class="link" href="{{ URL::Route($routePrefix.'.view',1) }}" title="View"><i class="fa fa-eye" aria-hidden="true"></i></a>&nbsp &nbsp &nbsp &nbsp<a class="link" href="{{ route($routePrefix.'.add') }}"><i class="fa fa-pencil-square" aria-hidden="true"></i></a>-->
                                <a class="link" href="{{ URL::Route($routePrefix.'.view',1) }}" title="View">Success</a>
