...
<div class="content-wrapper">
  ...
  <div class="row">      
    ...
    <a type="reset" class="btn btn-default" value="Active / Deactive"> Active / Deactive</a>   
    <a type="reset" class="btn btn-default" value="Delete">Delete</a>
    <a class="right" value="edit">Edit</a>
</div>
</div>
  	<hr>
	<div class="row">
