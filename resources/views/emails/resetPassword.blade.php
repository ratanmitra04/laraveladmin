                                                    ...
                                                    <tr>
                                                        <td align="left" class="textContent">
                                                            ...
                                                            <div style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#5F5F5F;line-height:135%;">Hello {{$userName}},<br/><br/>
                                                               You have requested to reset your login password. This is your verification code <span style="color:#205478"><b>{{$verificationcode}}</b></span>, using this code you can set a new password for login.<br/><br/>Thanks & Regards<br>
